        ...
        <div className="bg-customBlue h-screen">
            ...
            <main className="text-white m-10">
                ...
                <div className='flex justify-center items-center w-full mt-10 gap-10'>
                    ...
                    <div className='md:w-3/5 w-full flex flex-col justify-center items-center'>
                    ...
                    <div className='w-2/5 bg-customBlue h-full flex flex-col items-center justify-center text-center max-md:hidden'>
