    ...
    return (
        ...
        <div>
            ...
            <section className="bg-customBlue h-full md:h-screen justify-evenly items-center text-white flex flex-col">
                ...
                <div className="flex justify-center w-3/4 ps-8 max-md:items-center">
                    ...
                    <Card.Root className="h-80 bg-perfilCard rounded xl:w-1/4 w-2/4">
                ...
                <div className="flex justify-center max-md:items-center flex-col mb-8 md:flex-row gap-16 mt-8 rounded-2xl bg-perfilCard w-3/4 py-8 self-center ">
                    <div className="md:w-2/3 w-3/4 md:ps-12">
                    ...
                    <div className="md:w-1/3 w-3/4 flex justify-center">
